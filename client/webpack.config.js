...
module.exports = {
  ...
  plugins: [
    new HtmlWebpackPlugin({
      ...
      meta: {
        description:
          'Explore a collection of interactive web tools including a graphing calculator, real-time financial dashboard, task manager, digital footprint analyzer, lottery data tool, GitHub visualizer, and community bookmarks platform.',
        keywords:
        ...
        'og:image':
          'https://github.com/aniqatc/playground/blob/main/docs/screenshots/playground-light.png',
    ...
    ...(isDevelopment
      ...
      : [
          ...
          new WebpackPwaManifest({
            ...
            description:
              'Collection of interactive web tools featuring a graphing calculator, financial dashboard, task manager, digital footprint analyzer, and more built with modern web technologies.',
            theme_color: '#211e1f',
